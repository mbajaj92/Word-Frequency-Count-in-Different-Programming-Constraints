...
Style3 - In this style, we are allowed the use of variables, but we aren't allowed to create abstractions or procedures. The use of libraries need to be as minimal as possible. The implementation is done in Java.